jQuery(document).ready(function($){
  var language_display = $('input[name=googletranslateplugin_language_option]:checked').val();
  var display = $('select[name=googletranslateplugin_display] option:selected').val();
  var flag_display = $('input[name=googletranslateplugin_flags]:checked').val();
  var floating_widget_display = $('select[name=googletranslateplugin_floating_widget] option:selected').val();
  ...
  $('input[name=googletranslateplugin_flags]').change(function(){
  ...
  $('select[name=googletranslateplugin_floating_widget]').change(function() {
    if($(this).val()=='yes') {
      $('.floating-widget').removeClass('hidden');
    } else {
      $('.floating-widget').addClass('hidden');
  ...
  $('input[name=googletranslateplugin_analytics]').change(function() {
    var analytics = $(this);
  ...
  var analytics = $('input[name=googletranslateplugin_analytics]');
  if (analytics.is(':checked') )  {
