<?php
$gtp_css = get_option('googletranslateplugin_css');
$language_switcher_width = get_option('gtp_language_switcher_width');
$language_switcher_text_color = get_option('gtp_language_switcher_text_color');
$language_switcher_bg_color = get_option('gtp_language_switcher_bg_color');
$gtp_display = get_option('googletranslateplugin_display');
$floating_widget_position = get_option ('gtp_floating_widget_position');
$floating_widget_text_color = get_option ('gtp_floating_widget_text_color');
$floating_widget_bg_color = get_option('gtp_floating_widget_bg_color');

echo '<style>';
echo $gtp_css;

if(get_option('googletranslateplugin_flags') == 1) {
    if(get_option('googletranslateplugin_display') == 'Vertical') {
        ...
        if(get_option('googletranslateplugin_flags_alignment') == 'flags_right') {
    ...
    } elseif(get_option('googletranslateplugin_display') == 'SIMPLE' and get_option('googletranslateplugin_flags_alignment') == 'flags_right') {
    ...
    if(get_option('googletranslateplugin_flags_alignment') == 'flags_right') {
        ...
        echo '.gtp-clear{height:0px;clear:both;margin:0px;padding:0px;}';
    }

    if(get_option('googletranslateplugin_flags_alignment') == 'flags_left') {
        echo '#google_language_translator{clear:both;}';
        echo '#flags{width:165px;}';
        echo '#flags a{display:inline-block;margin-right:2px;}';
    } elseif(get_option('googletranslateplugin_flags_alignment') == 'flags_right') {
        echo '#flags{width:165px;}';
        echo '#flags a{display:inline-block;margin-left:2px;}';
    }
}

if(get_option('googletranslateplugin_active') == 1) {
    if(get_option('googletranslateplugin_showbranding') == 'Yes') {
        echo '#google_language_translator{width:auto!important;}';
        echo 'div.skiptranslate.goog-te-gadget{display:inline!important;}';
    } elseif(get_option('googletranslateplugin_showbranding') == 'No' and get_option('googletranslateplugin_display') != 'SIMPLE') {
    ...
    if(get_option('googletranslateplugin_translatebox') == 'no')
...
if(get_option('googletranslateplugin_flags') == 0 and get_option('googletranslateplugin_active') == 1)
    echo '#flags{display:none;}';

if(get_option('googletranslateplugin_active') == 1) {
    if(get_option('googletranslateplugin_toolbar') == 'Yes'){
        echo '#google_language_translator{color:transparent;}';
    } elseif(get_option('googletranslateplugin_toolbar') == 'No') {
...
if($floating_widget_position == 'bottom_left') {
    echo '#gtp-translate-trigger{left:20px;right:auto;}';
} elseif($floating_widget_position == 'top_right') {
    echo '#gtp-translate-trigger{bottom:auto;top:0;}';
    ...
    echo '#gtp-translate-trigger{bottom:auto;top:0;left:20px;right:auto;}';
    echo '.tool-container.tool-top{top:50px!important;bottom:auto!important;}';
    echo '.tool-container.tool-top .arrow{border-color:transparent transparent #d0cbcb;top:-14px;}';
} elseif ($floating_widget_position == 'top_center') {
    echo '#gtp-translate-trigger{bottom:auto;top:0;left:50%;margin-left:-63px;right:auto;}';
    echo '.tool-container.tool-top{top:50px!important;bottom:auto!important;}';
    echo '.tool-container.tool-top .arrow{border-color:transparent transparent #d0cbcb;top:-14px;}';
} elseif ($floating_widget_position == 'bottom_center') {
    echo '#gtp-translate-trigger{left:50%; margin-left:-63px; right:auto;}';
}

if(!empty($floating_widget_text_color))
    echo '#gtp-translate-trigger > span{color:'.$floating_widget_text_color.';}';

if(!empty($floating_widget_bg_color))
    echo '#gtp-translate-trigger{background:'.$floating_widget_bg_color.';}';

if(!empty($language_switcher_width) and isset($language_switcher_width) and $gtp_display != 'Horizontal')
